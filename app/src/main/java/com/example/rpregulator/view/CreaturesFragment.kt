...
class CreaturesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = CreaturesAdapter(
            creaturesViewModel.options,
            requireActivity(),
            CreaturesAdapter.OnClickListener {
        ...
        creaturesViewModel.navigateToCreaturesDetails.observe(viewLifecycleOwner, {
            it?.let {
                val action =
                    BestiaryFragmentDirections.actionBestiaryFragmentToCreatureDetailsFragment(it)
        ...
        creaturesViewModel.navigateToAddCreatures.observe(viewLifecycleOwner, {
            it?.let {
                val action =
                    BestiaryFragmentDirections.actionBestiaryFragmentToAddCreatureFragment()
                findNavController().navigate(action)
            }
        })
