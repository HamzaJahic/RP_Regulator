...
class AddPaperWorkFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        val addPaperWorkViewModel = ViewModelProvider(this, viewModelFactory).get(AddPaperWorkViewModel::class.java)

        binding.viewModel = addPaperWorkViewModel

        addPaperWorkViewModel.navigateToPaperWorks.observe(viewLifecycleOwner, Observer {
            it?.let{
                val action = AddPaperWorkFragmentDirections.actionAddPaperWorkFragmentToPaperworkFragment()
