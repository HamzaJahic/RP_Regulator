...
class BlessingsAdapter(options: FirebaseRecyclerOptions<CursesBlessingsHealth>, private val context: Context, private val user_id: String, val onClickListener: OnClickListener)
